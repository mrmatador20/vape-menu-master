import { LayoutDashboard, Package, ShoppingCart, BarChart3, Tag, Star, Truck, Settings, Megaphone, Shield, TestTube } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Teste de Notificações", url: "/admin/notification-test", icon: TestTube },
