...
<body style="margin: 0; padding: 0; background-color: #0f1419; font-family: 'Open Sans', sans-serif; color: #e6fffd;">

  <!-- E-mail principal -->
  <table role="presentation" style="width: 100%; padding: 20px 0; background-color: #0f1419;">
    <tr>
      <td align="center">
        <table role="presentation" style="max-width: 600px; width: 100%; background-color: #1a2332; border-radius: 12px; overflow: hidden; box-shadow: 0 0 40px rgba(0, 204, 255, 0.2);">
          ...
          <!-- Cabeçalho -->
          <tr>
            <td style="background: linear-gradient(135deg, #00ccff, #00d9a3); padding: 40px; text-align: center;">
              <h1 style="color: #ffffff; font-size: 36px; font-weight: bold; margin: 0 0 8px 0;">
                Vape-Menu-Express
              </h1>
              <p style="color: #ffffff; font-size: 16px; margin: 0; opacity: 0.8;">
          ...
          <tr>
            <td style="padding: 40px 40px 20px 40px;">
              <h2 style="color: #ffffff; font-size: 28px; font-weight: bold; margin-bottom: 24px; text-align: center;">
                🔐 Redefinição de Senha
              </h2>

              <p style="color: #e6fffd; font-size: 16px; line-height: 24px; margin-bottom: 20px;">
                Olá, <strong>${userEmail}</strong>! Recebemos uma solicitação para redefinir a senha da sua conta.
              ...
              <table role="presentation" style="width: 100%; margin: 32px 0;">
                <tr>
                  <td align="center">
                    <a href="${resetUrl}" style="background-color: #00ccff; border-radius: 8px; color: #0f1419; font-size: 18px; font-weight: bold; text-decoration: none; padding: 16px 48px; display: inline-block; box-shadow: 0 4px 12px rgba(0, 204, 255, 0.4);">
              ...
              <table role="presentation" style="width: 100%; background-color: rgba(0, 204, 255, 0.05); border-radius: 8px; padding: 20px; margin: 24px 0; border: 1px solid rgba(0, 204, 255, 0.2);">
                <tr>
                  <td>
                    <p style="color: #00ccff; font-size: 16px; font-weight: bold; margin-bottom: 12px;">
              ...
              <p style="color: #a3d9e6; font-size: 13px; margin-top: 24px; line-height: 20px;">
